...
**Matriz de brechas normativas laborales y de datos personales**

Laboratorio 02 de la suite de cumplimiento operable de **NiAnd Labs S.A.S.**

[![CI](https://github.com/AndreZzRg/niand-diagnostico-cumplimiento/actions/workflows/ci.yml/badge.svg)](https://github.com/AndreZzRg/niand-diagnostico-cumplimiento/actions/workflows/ci.yml)
[![Pages](https://github.com/AndreZzRg/niand-diagnostico-cumplimiento/actions/workflows/pages.yml/badge.svg)](https://github.com/AndreZzRg/niand-diagnostico-cumplimiento/actions/workflows/pages.yml)
[![CodeQL](https://github.com/AndreZzRg/niand-diagnostico-cumplimiento/actions/workflows/codeql.yml/badge.svg)](https://github.com/AndreZzRg/niand-diagnostico-cumplimiento/actions/workflows/codeql.yml)
...
### [▶ Abrir la aplicación](https://andrezzrg.github.io/niand-diagnostico-cumplimiento/)
...
Cuestionario guiado que evalúa el cumplimiento de una empresa colombiana frente a las obligaciones laborales y de protección de datos vigentes, y produce una matriz de brechas con semáforo por obligación, norma aplicable, autoridad competente y plazo sugerido de cierre.
...
```bash
git clone https://github.com/AndreZzRg/niand-diagnostico-cumplimiento.git
cd niand-diagnostico-cumplimiento
npm install
npm run dev
```
...
```bash
# Con GitHub CLI
gh repo create AndreZzRg/niand-diagnostico-cumplimiento --public --source=. --remote=origin --push

# O de forma manual, si ya creó el repositorio vacío en github.com
git remote add origin https://github.com/AndreZzRg/niand-diagnostico-cumplimiento.git
git branch -M main
...
```
https://andrezzrg.github.io/niand-diagnostico-cumplimiento/
```
...
| **Ley 2466 de 2025** | Actualización del Reglamento Interno de Trabajo. El plazo venció el 25 de junio de 2026. |
| **Circular MinTrabajo 0048 de 2026** | La falta de actualización del RIT no justifica dejar de aplicar el debido proceso. |
| **Ley 2365 de 2024** | Prevención y sanción del acoso sexual laboral. |
| **Ley 1010 de 2006** | Acoso laboral y Comité de Convivencia Laboral. |
| **Ley 1581 de 2012** | Protección de datos personales y registro de bases ante la SIC. |
