# Arquitectura — Diagnóstico de Cumplimiento
...
Una carpeta por módulo: `cuestionario`, `matriz-de-brechas`, `plan-de-cierre`, `reporte-exportable`.
...
`localStorage` bajo claves con prefijo `niand-diagnostico-cumplimiento:`.
