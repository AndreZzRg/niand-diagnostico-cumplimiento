# Registro de decisiones de arquitectura — Diagnóstico de Cumplimiento
...
**Contexto.** GitHub Pages sirve el proyecto bajo `/niand-diagnostico-cumplimiento/`. Fijar esa ruta en la
